...
public class SteamLobbyManager : MonoBehaviour
{
    ...
    public  void OnLobbyJoinRequest()
    {
    ...
    {
        await CreateLobbyAsync();  //Function for the button because a function called by a button has to be a void but createLobbyAsync has to return a bool for something but i dont remember what in what script
    }
